      ...
      <section id="about" className="about w-full py-20 px-0   h-screen">
        <div className="main w-11/12 max-w-screen-xl flex smx:flex-col my-10 mx-auto items-center justify-around gap-4 mt-36 tablet:flex-col">
          ...
          <div className="about-text w-500 max-w-fit">
            ...
            <p className="text-text tracking-wide text-base mb-11 smx:ml-5 smx:mb-6">
              I am Front-end web developer. Lorem ipsum, dolor sit amet
              consectetur adipisicing elit. Praesentium aut inventore pariatur,
              voluptas nisi, maiores voluptatem eveniet
            </p>
            <a
