    ...
    <>
      ...
      >
        <div className="main w-11/12 max-w-screen-xl flex smx:flex-col my-12 mx-auto items-center justify-around gap-1 mt-28 tablet:gap-10 relative tablet:top-24 smx:-mt-6 ">
          <div className="about hidden smx:block">
            <h2 className="text-text text-3xl capitalize mb-5  smx:mt-4 smx:ml-4 smx:mb-1 text-bold text-left">
              About <span className="text-blue">Me</span>
            </h2>
            <h3 className="text-blue text-xl capitalize -mb-2 trackin g-wider  mt-0 ml-4  ">
              Graphic Designer!
            </h3>
          </div>
          <img
          ...
          <div className="about-text w-500 max-w-fit smx:-mt-8">
            ...
            <p className="text-text tracking-wide text-base mb-11 smx:ml-5 smx:mb-9  g  ">
