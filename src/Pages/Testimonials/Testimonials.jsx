      ...
      >
        <div className="container px-6 py-12 mx-auto">
          <div className="grid items-center gap-4 xl:grid-cols-5">
            <div className="max-w-2xl mx-auto my-2 space-y-4 text-center xl:col-span-2 xl:text-left">
              <h2 className="text-4xl font-bold ">Testimonials</h2>
              <p className="text-blue font-semibold">
                What Client Say About Us <span>___________?</span>
              </p>
            </div>
            <div className="p-6 xl:col-span-3">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="grid content-center gap-4">
                  <div className="relative g border-2 border-solid border-transparent hover:bg-transparent hover:border-blue rounded-2xl p-5 ">
                    <p>
